...
class RapidsTestSettings extends BackendTestSettings {
  ...
  enableSuite[RapidsLiteralExpressionSuite]
    .exclude("SPARK-37967: Literal.create support ObjectType", WONT_FIX_ISSUE("ObjectType is not supported on GPU"))
